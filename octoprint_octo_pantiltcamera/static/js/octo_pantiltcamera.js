$(function() {
    function PantiltViewModel(parameters) {
        ...
        self.requestData = function() {
            OctoPrint.simpleApiGet("octo_pantiltcamera").done(function(response) {
        ...
        self.sendSetCommand = function() {
            OctoPrint.simpleApiCommand("octo_pantiltcamera", "set", {panValue: self.panValue(), tiltValue: self.tiltValue()}).done(self.requestData);
        };
        self.sendCommand = function(command) {
            OctoPrint.simpleApiCommand("octo_pantiltcamera", command, {stepSize: self.stepSize()}).done(self.requestData);
        };
    }
